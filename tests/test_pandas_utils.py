...
from hoopstats import create_pd_data_frame_from_html_table
...
def test_create_pd_data_frame_from_html_table(monkeypatch):
    ...
    df = create_pd_data_frame_from_html_table(mock_html_content, "test_table")
...
def test_create_pd_data_frame_from_html_table_no_table(monkeypatch):
    ...
    with pytest.raises(ValueError):
        create_pd_data_frame_from_html_table(mock_html_empty_content, "test_table")
